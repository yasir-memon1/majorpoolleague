...
const SignUpPage = () => {
    return (
        <RegPage>
          ...
          <div>
            <h3 className="font-semibold text-gray-600">Sign up</h3>
          ...
          <div className="flex justify-start flex-col gap-">
            ...
            <div className="flex w-full gap-4">
                <select  className="h-11 text-gray-600 px-4 outline-none border-[1px] border-gray-400 flex-1 rounded-sm appearance-none focus:border-blue">
          ...
          <label htmlFor="agree " className="text-gray-600 leading-tight text-sm">I would like to receive commercial e-mails from MLP.com and their partners.</label>
          </div>
          ...
          <div>
            <p className="text-gray-600 leading-tight text-sm">I understand and agree to be bound by the MLP.com Terms of Use and Privacy Policy</p>
          </div>
